...
/* DEFINITIONS -----------------------------------*/   
/*------------------------------------------------*/
#define NAME_IMG_OUT_ORIGINALE "image-TpIFT6150-1-Ae-img"
#define NAME_IMG_OUT_SPECTRE "image-TpIFT6150-1-Ae-spc"
...
int main(int argc,char **argv)
 {
  ...
  system("display image-TpIFT6150-1-Ae-img.pgm&");
